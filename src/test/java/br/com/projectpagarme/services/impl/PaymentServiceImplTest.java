...
public class PaymentServiceImplTest {
    ...
    public void createANewPaymentWithSuccessfullyItShouldReturnOk(){
        Assert.assertEquals(itIsReturnAnObjectOfPaymentEntity(), paymentService.create(MOCK_DEBIT_CARD));
    }

    @Test
    public void createANewPaymentInCreditWithSuccessfullyItShouldReturnOk(){
        Assert.assertEquals(itIsReturnAnObjectOfPaymentEntityWithCredit(), paymentService.create(MOCK_CREDIT_CARD));
    }
