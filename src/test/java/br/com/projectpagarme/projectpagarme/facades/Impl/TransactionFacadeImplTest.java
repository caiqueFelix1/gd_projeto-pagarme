...
import br.com.projectpagarme.projectpagarme.dtos.responses.PaymentResponseDTO;
...
import br.com.projectpagarme.projectpagarme.facades.impl.TransactionFacadeImpl;
...
public class TransactionFacadeImplTest {
    ...
    public void createANewTransactionWithSuccessfullyItShouldReturnOk() throws Exception{
        assertEquals(itIsReturningAnObjectOfTransactionResponseDTO(), transactionFacade.create(itIsReturningAnObjectOfTransactionRequestDTO()));
    }

    @Test
    public void createANewTransactionWithCreditCardSuccessfullyItShouldReturnOk() throws Exception{
        assertEquals(itIsReturningAnObjectOfTransactionResponseDTOWithCreditCard(), transactionFacade.create(itIsReturningAnObjectOfTransactionRequestDTOWithCreditCard()));
    }
