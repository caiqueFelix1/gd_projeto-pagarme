...
public class TransactionServiceImplTest {
    ...
    public void createANewTransactionWithSuccessfullyItShouldReturnOk() throws Exception{
        assertEquals(itIsReturnAnObjectOfTransactionEntityWithId(), transactionService.create(itIsReturnAnObjectOfTransactionEntity()));
    }

    @Test
    public void createANewTransactionWithCreditCardSuccessfullyItShouldReturnOk() throws Exception{
        assertEquals(itIsReturnAnObjectOfTransactionEntityWithCreditCardWithId(), transactionService.create(itIsReturnAnObjectOfTransactionEntityWithCreditCard()));
    }
